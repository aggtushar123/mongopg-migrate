...
- **Core modules**:
  ...
  - `mapping/propose.py` — rule-based + optional LLM-assisted mapping generation (field/table matching, one-to-many split detection, `id_strategy` inference, discriminator detection for polymorphic collections)
